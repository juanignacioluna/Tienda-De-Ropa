    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-sm">
                ...
                <h1 style="text-align: center; margin-top: 20px;">MUJERES</h1>
        ...
        <div style="text-align: center;" class="row secciones">
            ...
            <div class="col-4 ">
                ...
                <form id="camisas" action="seccionM.php" method="post">
            ...
            <div class="col-4">
                ...
                <form id="vestidos" action="seccionM.php" method="post">


                    <input type="submit" value="VESTIDOS" class="list-group-item list-group-item-action">
            ...
            <div class="col-4">
                ...
                <form id="enteros" action="seccionM.php" method="post">


                    <input type="submit" value="ENTEROS" class="list-group-item list-group-item-action">
        ...
        <div style="text-align: center;"  class="row secciones">
            ...
            <div class="col-4">
                ...
                <form id="bikinis" action="seccionM.php" method="post">


                    <input type="submit" value="BIKINIS" class="list-group-item list-group-item-action">
            ...
            <div class="col-4">
                ...
                <form id="carteras" action="seccionM.php" method="post">


                    <input type="submit" value="CARTERAS" class="list-group-item list-group-item-action">
            ...
            <div class="col-4">
                ...
                <form id="tapados" action="seccionM.php" method="post">


                    <input type="submit" value="TAPADOS" class="list-group-item list-group-item-action">
        ...
        <div style="text-align: center;"  class="row secciones">
            ...
            <div class="col-4 ">
                ...
                <form id="remeras" action="seccionM.php" method="post">


                    <input type="submit" value="REMERAS" class="list-group-item list-group-item-action">
            ...
            <div class="col-4">
                ...
                <form id="buzos" action="seccionM.php" method="post">


                    <input type="submit" value="BUZOS" class="list-group-item list-group-item-action">
            ...
            <div class="col-4">
                ...
                <form id="pantalones" action="seccionM.php" method="post">
                ...
                <div id="p1">
                    <div id="p">
                        ...
                        <?php
                                        ...
                                        $sql = "select * from productos where genero='mujer' order by rand()";
                                        ...
                                        while($row01 = mysqli_fetch_array($result)){
                                                ...
                                                if(($f==0) || ($f%4==0)){
                                                        ...
                                                        <div class="col-sm">
                                                                ...
                                                                <a href="producto.php?g=m&id=' . $row01['id'] . '"><img src="' . $row01['foto1'] . '" class="card-img-top"></a>
                                                                <div class="card-body">
