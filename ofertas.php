                ...
                <div class="row">
                      ...
                      <div class="row">
                            ...
                            <div class="col-sm">
                              ...
                              <h1 style="text-align: center; margin-top: 20px;">OFERTAS</h1>
                                ...
                                <!-- <div class="card" style="width: 18rem;">
                                                        <a href="producto.php"><img src="https://content.ib2c.com.ar/224/products/276857_1100x1500.jpg" class="card-img-top" alt="..."></a>
                                                        <div class="card-body">
                                                          <p class="card-text">Nuevo Hoodie Básica Negro</p>
                                                          <b style="color: green;">$ 199.00 MXN</b> <b style="text-decoration:line-through;">$ 499.00 MXN</b>
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div id="p1">
                                                                ...
                                                                <?php
                                                                                ...
                                                                                $sql = "select * from productos where oferta=1 order by rand()";
                                                                                ...
                                                                                while($row01 = mysqli_fetch_array($result)){
                                                                                        ...
                                                                                        if(($f==0) || ($f%4==0)){
                                                                                                ...
                                                                                                <div class="col-sm">
                                                                                                        ...
                                                                                                        <b style="color: green;">$'. $row01['precioActual'] .'</b>
                                                                                                        <b style="text-decoration:line-through;">$'. $row01['precioAnterior'] .'</b>
                                                                                                        </div>
                                                                                                        </div>
